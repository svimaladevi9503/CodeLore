    ...
    <div className="flex flex-col gap-6 h-full">
        ...
        <details className="group">
          ...
          <form onSubmit={addNewKnowledgeChunk} className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3 pt-3 border-t border-slate-800">
            <div className="flex flex-col gap-1">
              <label className="text-[11px] font-mono text-slate-500">Document filename</label>
              <input
                type="text"
            ...
            <div className="flex flex-col gap-1">
              <label className="text-[11px] font-mono text-slate-500">Header / Section Topic</label>
              <input
                type="text"
            ...
            <div className="flex flex-col gap-1 md:col-span-2">
              <label className="text-[11px] font-mono text-slate-500">Snippet Content Body</label>
              <textarea
            ...
            <div className="md:col-span-2 flex items-center justify-between mt-1 pt-1">
              ...
              <button
                type="submit"
                className="bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-sans text-[11px] font-medium py-1 px-3 rounded cursor-pointer transition active:scale-95 ml-auto"
              >
                Register Chunk
              </button>
            </div>
      ...
      <div className="flex-1 bg-slate-950/40 border border-slate-850 rounded-xl flex flex-col min-h-[300px] overflow-hidden relative">
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          {chatLog.length > 1 && chatLog.map((msg, idx) => {
